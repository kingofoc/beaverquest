...
export default function Footer() {
 ...
 return (
  <div className="fixed bottom-0 insect-x-0 z-50 w-full">
    <div className="absolute bottom-0 insect-x-0 z-0 h-32 w-full secondary-bg-faded backdrop-blur-sm mask-t-from-80%"></div>
