...
export default function Footer() {
 ...
 return (
  <div className="fixed bottom-0 insect-x-0 z-50">
    <div className="absolute bottom-0 insect-x-0 z-0 h-32 secondary-bg-faded backdrop-blur-sm mask-t-from-80%"></div>
