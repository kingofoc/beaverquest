...
export default function Footer() {
 ...
 return (
  <div className="grid grid-cols-6 fixed bottom-0 left-0 w-full">
   <div className="grid grid-cols-3 col-span-4 col-start-2 col-end-5 gap-2 primary-bg rounded-full p-1 mb-8">
